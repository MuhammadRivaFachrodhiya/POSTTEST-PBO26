                ...
                case 3:
                    ...
                    if (!daftarMebel.isEmpty()) {
                        ...
                        if (idB >= 0 && idB < daftarMebel.size()) {
                            ...
                            if (jumlah <= 0) {
                                System.out.println("\nPesan: Jumlah pembelian harus lebih dari 0.");
                            } else if (jumlah > barang.getStok()) {
                                // Jika jumlah beli lebih banyak dari stok
                                System.out.println("\nPesan: Maaf, transaksi gagal! Stok tidak mencukupi. (Sisa stok: " + barang.getStok() + ")");
                            } else {
                                ...
                                if (barang instanceof Perawatan) {
                                    System.out.println("\n--- INFO PERAWATAN & PERAKITAN ---");
                                    Perawatan info = (Perawatan) barang;

                                    System.out.print("Status Perakitan : ");
                                    if (info.butuhPerakitan()) {
                                        System.out.println("Perlu dirakit sendiri.");
                                    } else {
                                        System.out.println("Dikirim utuh (tidak perlu dirakit).");
                                    }

                                    System.out.print("Cara Perawatan   : ");
                                    info.caraPerawatan();
                                }

                                System.out.println("\nPesan: Transaksi berhasil! Stok telah dikurangi.");
                            }
                        } else {
